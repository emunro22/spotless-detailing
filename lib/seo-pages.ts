...
const CLEANING_DESC_TEMPLATES: ((f: AreaFact) => string)[] = [
  ...
  (f) => `Commercial and domestic pressure washing covering ${f.name} and ${f.county}. Driveways, patios and building exteriors. Free quotes, fully insured.`,
...
export const VALETING_SERVICE_PAGES: SeoPage[] = [
  {
    ...
    h1: 'Car Valeting Near Me in Glasgow & Surrounding Areas',
    description:
  ...
  },
  {
    ...
    h1: 'Mobile Valeting That Comes to Your Door',
    description:
  ...
  },
  {
    ...
    h1: 'Quick Car Valet with a Fast Turnaround',
    description:
  ...
  },
  {
    ...
    h1: 'Deep Clean Valet for That New-Car Feeling',
    description:
  ...
  },
  {
    ...
    h1: 'Mobile Car Detailing with Premium Results at Your Door',
    description:
  ...
  },
  {
    ...
    h1: 'Ceramic Coating for Long-Term Paint Protection',
    description:
  ...
  },
  {
    ...
    h1: 'Interior Car Cleaning, Deep Cleaned & Steam Cleaned',
    description:
...
export const CLEANING_SERVICE_PAGES: SeoPage[] = [
  ...
  },
  {
    ...
    h1: 'Driveway Cleaning for Block Paving, Tarmac & Concrete',
    description:
